use crate::{Error, Response, Result, WarpResult};
...
pub async fn working() -> WarpResult<impl warp::Reply> {
...
fn not_working_model() -> Result<String> {
    Err(Error::BadReq(String::from("Some error occurred")))
}

// Handler for not_working API
pub async fn not_working() -> WarpResult<impl warp::Reply> {
